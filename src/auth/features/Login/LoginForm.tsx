...
export default function LoginForm({onSuccessLogin}: Props) {
    const {
        register,
        handleSubmit,
        onFormSubmit,
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    sm:text-sm sm:leading-6 ${errors.email ? 'border-red-500' : ''}`}
                                />
                                {errors.email && (
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                <input
                                    ...
                                    {...register('password')}
                                    className={`
                                    w-full rounded-md border-1 py-1.5 text-gray-900
                                     shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 
                                    focus:ring-2 focus:ring-inset 
                                    focus:ring-indigo-600 sm:text-sm sm:leading-6 ${errors?.password ? 'border-red-500' : ''}`}
                                />
                                {errors?.password && (
